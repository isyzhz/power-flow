...
if ~isempty(mpc.bus)
    ...
    if dc                               %% DC formulation
        ...
        switch alg
            case {'CJ','CJ3-VK','CJ3-VTEMP','CJ2-1','CJ2-2','NR', 'NR-SP', 'NR-SC', 'NR-SH', 'NR-IP', 'NR-IC', 'NR-IH'}  %% all 7 variants supported
        ...
        while (repeat)
            ...
            switch alg                  
                case {'CJ'}
                    CJpf = @CJ;
                    [V, success, iterations] = CJpf(Ybus, Sbus, V0, ref, pv, pq, mpopt);
                case {'CJ3-VK'}
                    CJthreeVk = @CJ3_Vk;
                    [V, success, iterations] = CJthreeVk(Ybus, Sbus, V0, ref, pv, pq, mpopt); 
                case {'CJ3-VTEMP'}
                    CJthreeVtemp = @CJ3_Vtemp;
                    [V, success, iterations] = CJthreeVtemp(Ybus, Sbus, V0, ref, pv, pq, mpopt);                                        
                case {'CJ2-1'}
                    CJtwoone = @CJ2_1;
                    [V, success, iterations] = CJtwoone(Ybus, Sbus, V0, ref, pv, pq, mpopt);
                case {'CJ2-2'}
                    CJtwotwo = @CJ2_2;
                    [V, success, iterations] = CJtwotwo(Ybus, Sbus, V0, ref, pv, pq, mpopt);                
            ...
            %% update data matrices with solution
            switch alg
                case {'CJ','CJ3-VK','CJ3-VTEMP','CJ2-1','CJ2-2','NR', 'NR-SP', 'NR-SC', 'NR-SH', 'NR-IP', 'NR-IC', 'NR-IH', 'FDXB', 'FDBX', 'GS'}
